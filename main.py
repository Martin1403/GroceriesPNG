...
parser.add_argument('--icons', type=str, default=r"data/icons", help='Path to images')
parser.add_argument('--backgrounds', type=str, default=r"data/backgrounds", help='Path to backgrounds')
...
parser.add_argument('--max_size', type=int, default=250, help='Max image size')
parser.add_argument('--groceries', type=tuple, default=(10, 15), help='Number of groceries. (min, max)')
parser.add_argument('--number', type=int, default=10, help='Number of images created')
parser.add_argument('--area', type=int, default=200, help='Minimum polygon area ')
parser.add_argument('--version', type=str, default="004", help='Version number')
