...
parser.add_argument('--icons', type=str, default=r"data/mixed_sizes_sorted", help='Path to images')
...
parser.add_argument('--max_size', type=int, default=200, help='Max image size')
parser.add_argument('--groceries', type=tuple, default=(10, 15), help='Number of groceries. (min, max)')
parser.add_argument('--number', type=int, default=200, help='Number of images created')
